...
#pragma comment(lib, "apbase_lite.lib")
#endif
#endif
...
typedef void            (APBASE_DECL * AP_SetSensorRegister_PROC )(void *pContext, mi_addr_type nAddrType, ap_u32 nAddrSpace, ap_u32 nAddr, ap_u32 nDataBits, ap_u32 nValue, int nSpaceMask);
